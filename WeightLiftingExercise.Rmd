...
Estimated Out of Bag error is 86%. This is measure is the equivalent of accuracy using cross validation [(see link)](http://www.stat.berkeley.edu/~breiman/RandomForests/cc_home.htm)  
...
The accuracy in the test data is above 99%, so this seems to be a pretty good model for our purposes. 
